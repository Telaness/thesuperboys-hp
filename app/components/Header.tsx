...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/THESUPERBOYS_123",
    icon: (
  ...
  {
    label: "X",
    href: "https://x.com/THESUPERBOYS123",
    icon: (
      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@thesuperboys_123",
    icon: (
      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@THESUPERBOYS123",
    icon: (
      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
  ...
  return (
    <>
      ...
      >
        ...
        >
          <nav className="flex flex-col items-center gap-1 pointer-events-auto">
          ...
          {/* Social links */}
          <div
            className="flex items-center gap-4 mt-10 pointer-events-auto transition-all duration-500"
            style={{
