        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6">
          {members.map((member) => (
            ...
            >
              <Image
                src={member.image}
                alt={`${member.name}（${member.realName}）- THE超BOYS メンバー`}
                fill
            ...
            <div className="flex flex-col md:flex-row max-h-[85vh] overflow-y-auto">
              <div className="relative w-full md:w-1/2 aspect-[4/3] sm:aspect-[3/4] bg-black flex-shrink-0">
                <Image
                  ...
                  alt={`${selectedMember.name}（${selectedMember.realName}）- THE超BOYS メンバー`}
                  fill
                ...
                <div className="pt-2 sm:pt-4">
                  ...
                  <div className="flex gap-3">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="w-9 h-9 rounded-full bg-gray-200 hover:bg-gray-300 transition-colors flex items-center justify-center"
                      aria-label={`${selectedMember.name}のTikTok`}
                    >
                      <svg className="w-4 h-4 fill-gray-600" viewBox="0 0 24 24">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="w-9 h-9 rounded-full bg-gray-200 hover:bg-gray-300 transition-colors flex items-center justify-center"
                      aria-label={`${selectedMember.name}のX`}
                    >
                      <svg className="w-4 h-4 fill-gray-600" viewBox="0 0 24 24">
